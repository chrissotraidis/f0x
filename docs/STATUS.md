...
| Lifecycle / 60 Hz / high refresh | Partially verified / not started | A Simulator Home background + relaunch re-attached the touch overlay neutrally, and touch input clears on menu/cancel paths. Full mobile background/audio/render suspension, correct 60 Hz acceptance, and later Match Display/120 Hz remain open. |
