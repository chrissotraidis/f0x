...
| App identity / public README | Developer Preview 1 packaged for release | Original opaque 1024x1024 F0X artwork remains the compiled Apple app icon. The README uses an owner-approved physical-iPad racing image and links the ROM-free unsigned `v0.1.0-preview.1` IPA with its exact checksum and re-signing boundary. No App Store or TestFlight build is claimed. |
...
5. Collect hands-on iPhone acceptance against Developer Preview 1; its package
